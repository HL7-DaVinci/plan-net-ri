...
public class ApiProperties {
	...
	/** Dedicated database for the crawler tables; a blank url shares HAPI's datasource. */
	private final Datasource datasource = new Datasource();

	public static class Datasource {

		/** JDBC url, e.g. {@code jdbc:sqlite:/data/crawler/crawler.sqlite} or {@code jdbc:postgresql://...}. */
		private String url;
